...
import io.github.kindcensor.annotation.bind.AnnotationRegistry
import io.github.kindcensor.ksp.Binding
import io.github.kindcensor.ksp.GET_BINDINGS_METHOD
import io.github.kindcensor.ksp.INITIALIZER_CLASS
import io.github.kindcensor.ksp.ir.AnnotationIR
...
internal object KotlinPoetOutputGenerator : OutputGenerator {
    ...
    override fun generate(classesIR: Iterable<ClassIR>): OutputGeneratorResult {
        ...
        return FileSpec.builder("io.github.kindcensor.ksp", "ToStringFunctions")
